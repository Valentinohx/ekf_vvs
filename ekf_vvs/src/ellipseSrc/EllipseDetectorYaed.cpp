...
//    if (sz_ell == 3)
//    {
//        struct point_pair  //to store the point pair
//        {
//            point_pair(Point p1, Point p2 ): _p1(p1) , _p2(p2){}
//            Point _p1, _p2;
//            double dist = cv::norm(_p1-_p2);

//            Point _ppcenter = Point((_p1.x + _p2.x)/2, (_p1.y + _p2.y)/2);
//        };


//        Point xc1, xc2, xc3;
//        xc1.x = ellipses[0]._xc;
//        xc1.y = ellipses[0]._yc;

//        xc2.x = ellipses[1]._xc;
//        xc2.y = ellipses[1]._yc;

//        xc3.x = ellipses[2]._xc;
//        xc3.y = ellipses[2]._yc;

//        point_pair p_p1(xc1,xc2);
//        point_pair p_p2(xc2,xc3);
//        point_pair p_p3(xc1,xc3);

//        point_pair max_dist_pair(xc1,xc2);
//        Point Third_point = xc3;

//        if (p_p2.dist >= p_p1.dist && p_p2.dist >= p_p3.dist )
//        {
//            max_dist_pair = p_p2;
//            Third_point = xc1;
//        }

//        if (p_p3.dist >= p_p1.dist && p_p3.dist >= p_p2.dist )
//        {
//            max_dist_pair = p_p3;
//            Third_point = xc2;
//        }

//        Point Fourth_ellip_Center = Point( (2*max_dist_pair._ppcenter.x - Third_point.x),
//                                           (2*max_dist_pair._ppcenter.y - Third_point.y) );
//        circle(output,Point(cvRound(Fourth_ellip_Center.x), cvRound(Fourth_ellip_Center.y)), 2, Scalar(0,255,0));
//    }
    ...
    for (int i = 0; i < n; ++i)
    {
        ...
        circle(output,Point(cvRound(e._xc), cvRound(e._yc)), 2, Scalar(0,255,0));
    }
}
